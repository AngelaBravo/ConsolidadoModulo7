...
.dos {
    border: 1px solid rgb(75, 211, 221);
    color: rgb(75, 211, 221);
}
...
.cuatro {
    border: 1px solid rgb(245, 42, 211);
    color: rgb(245, 42, 211);
}

.cinco {
    border: 1px solid rgb(27, 99, 12);
    color: rgb(27, 99, 12);
}

.seis {
    border: 1px solid rgb(172, 115, 50);
    color: rgb(172, 115, 50);
}
</style>
